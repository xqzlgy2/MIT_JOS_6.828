...
sys_env_destroy(envid_t envid)
{
  ...
  80013e:	00 
  80013f:	c7 44 24 08 a2 0e 80 	movl   $0x800ea2,0x8(%esp)
  800146:	00 
  800147:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014e:	00 
  80014f:	c7 04 24 bf 0e 80 00 	movl   $0x800ebf,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001c4:	c7 04 24 d0 0e 80 00 	movl   $0x800ed0,(%esp)
  ...
  8001da:	e8 53 00 00 00       	call   800232 <vcprintf>
	cprintf("\n");
  8001df:	c7 04 24 f4 0e 80 00 	movl   $0x800ef4,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80026e:	e8 8a 01 00 00       	call   8003fd <vprintfmt>
	sys_cputs(b.buf, b.idx);
