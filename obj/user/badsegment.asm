...
libmain(int argc, char **argv)
{
  ...
  800052:	e8 0d 01 00 00       	call   800164 <sys_getenvid>
  ...
  80006e:	7e 07                	jle    800077 <libmain+0x37>
		binaryname = argv[0];
  ...
  800088:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80008b:	8b 75 fc             	mov    -0x4(%ebp),%esi
  80008e:	89 ec                	mov    %ebp,%esp
  800090:	5d                   	pop    %ebp
  800091:	c3                   	ret    
	...
...
sys_env_destroy(envid_t envid)
{
  ...
  80013a:	00 
  80013b:	c7 44 24 08 a2 0e 80 	movl   $0x800ea2,0x8(%esp)
  800142:	00 
  800143:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014a:	00 
  80014b:	c7 04 24 bf 0e 80 00 	movl   $0x800ebf,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001c0:	c7 04 24 d0 0e 80 00 	movl   $0x800ed0,(%esp)
  ...
  8001d6:	e8 53 00 00 00       	call   80022e <vcprintf>
	cprintf("\n");
  8001db:	c7 04 24 f4 0e 80 00 	movl   $0x800ef4,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  800219:	e8 8a fe ff ff       	call   8000a8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80026a:	e8 8e 01 00 00       	call   8003fd <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800282:	e8 21 fe ff ff       	call   8000a8 <sys_cputs>
