...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  80003a:	c7 04 24 b8 0e 80 00 	movl   $0x800eb8,(%esp)
  ...
  800052:	c7 04 24 c6 0e 80 00 	movl   $0x800ec6,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  800072:	e8 0d 0b 00 00       	call   800b84 <sys_getenvid>
...
exit(void)
{
  ...
  8000c1:	e8 61 0a 00 00       	call   800b27 <sys_env_destroy>
}
  8000c6:	c9                   	leave  
  8000c7:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000f5:	e8 ce 09 00 00       	call   800ac8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800146:	e8 92 01 00 00       	call   8002dd <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80015e:	e8 65 09 00 00       	call   800ac8 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800249:	0f be 80 e7 0e 80 00 	movsbl 0x800ee7(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800372:	ff 24 95 74 0f 80 00 	jmp    *0x800f74(,%edx,4)
  ...
  80044a:	c7 44 24 08 08 0f 80 	movl   $0x800f08,0x8(%esp)
  800451:	00 
  ...
  80047f:	ba f8 0e 80 00       	mov    $0x800ef8,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b5a:	00 
  800b5b:	c7 44 24 08 e8 10 80 	movl   $0x8010e8,0x8(%esp)
  800b62:	00 
  800b63:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b6a:	00 
  800b6b:	c7 04 24 05 11 80 00 	movl   $0x801105,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800be0:	c7 04 24 14 11 80 00 	movl   $0x801114,(%esp)
  800be7:	e8 7f f5 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800bec:	89 74 24 04          	mov    %esi,0x4(%esp)
  800bf0:	8b 45 10             	mov    0x10(%ebp),%eax
  800bf3:	89 04 24             	mov    %eax,(%esp)
  800bf6:	e8 0f f5 ff ff       	call   80010a <vcprintf>
	cprintf("\n");
  800bfb:	c7 04 24 c4 0e 80 00 	movl   $0x800ec4,(%esp)
  800c02:	e8 64 f5 ff ff       	call   80016b <cprintf>
