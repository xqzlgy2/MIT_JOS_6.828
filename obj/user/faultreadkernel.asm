	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800239:	0f be 80 d9 0e 80 00 	movsbl 0x800ed9(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800362:	ff 24 95 68 0f 80 00 	jmp    *0x800f68(,%edx,4)
  ...
  80043a:	c7 44 24 08 fa 0e 80 	movl   $0x800efa,0x8(%esp)
  800441:	00 
  ...
  80046f:	ba ea 0e 80 00       	mov    $0x800eea,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b4a:	00 
  800b4b:	c7 44 24 08 dc 10 80 	movl   $0x8010dc,0x8(%esp)
  800b52:	00 
  800b53:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b5a:	00 
  800b5b:	c7 04 24 f9 10 80 00 	movl   $0x8010f9,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bd0:	c7 04 24 08 11 80 00 	movl   $0x801108,(%esp)
  ...
  800be6:	e8 13 f5 ff ff       	call   8000fe <vcprintf>
	cprintf("\n");
  800beb:	c7 04 24 2c 11 80 00 	movl   $0x80112c,(%esp)
