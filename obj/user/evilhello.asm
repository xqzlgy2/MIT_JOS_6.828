...
sys_env_destroy(envid_t envid)
{
  ...
  80014a:	00 
  80014b:	c7 44 24 08 b2 0e 80 	movl   $0x800eb2,0x8(%esp)
  800152:	00 
  800153:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80015a:	00 
  80015b:	c7 04 24 cf 0e 80 00 	movl   $0x800ecf,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001d0:	c7 04 24 e0 0e 80 00 	movl   $0x800ee0,(%esp)
  ...
  8001e6:	e8 53 00 00 00       	call   80023e <vcprintf>
	cprintf("\n");
  8001eb:	c7 04 24 04 0f 80 00 	movl   $0x800f04,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80027a:	e8 8e 01 00 00       	call   80040d <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800379:	0f be 80 06 0f 80 00 	movsbl 0x800f06(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004a2:	ff 24 95 94 0f 80 00 	jmp    *0x800f94(,%edx,4)
  ...
  80057a:	c7 44 24 08 27 0f 80 	movl   $0x800f27,0x8(%esp)
  800581:	00 
  ...
  8005af:	ba 17 0f 80 00       	mov    $0x800f17,%edx
